  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glow: "bg-card border-primary/30 shadow-[0_0_40px_hsl(270,100%,50%,0.3)]",
        interactive: "bg-card border-border hover:border-primary/50 hover:shadow-[0_0_40px_hsl(270,100%,50%,0.2)] cursor-pointer",
      },
    },
    defaultVariants: {
      variant: "default",
