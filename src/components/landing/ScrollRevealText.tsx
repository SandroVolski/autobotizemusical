...
export const ScrollRevealText = () => {
  ...
  useEffect(() => {
    ...
    const setupReveal = () => {
      ...
      tl.to(
        ...
        {
          color: (i, target) => {
            return (target as HTMLElement).dataset.highlight === "true" ? "#8B5CF6" : "#FFFFFF";
          },
          duration: 0.5,
          stagger: 0.04,
          ease: "power2.out",
  ...
  return (
    <section ref={sectionRef} className="py-20 flex flex-col items-center justify-center px-6 text-center">
      ...
      <div ref={containerRef} className="max-w-4xl mx-auto text-xl md:text-3xl lg:text-4xl font-bold" />
    </section>
  );
};
